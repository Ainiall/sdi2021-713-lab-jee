...
<body>
	...
	<%
		...
		if (nombre != null && nombre.equals("admin") && password != null && password.equals("admin")) {
			...
			// ejercicio 3: todo usuario es valido para el blog
			// no se elimina la sesion, se usa para el comentario
			request.getSession().setAttribute("usuario", nombre);
			response.sendRedirect("index.jsp");

		} else {
			// Credencial invalido, se elimina de la sesion (esto es opcional)
